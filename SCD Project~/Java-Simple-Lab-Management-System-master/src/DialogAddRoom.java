...
public class DialogAddRoom extends JDialog
{
    ...
    public DialogAddRoom(JDialog parent, ArrayList<Room> rooms)
    {
        ...
        this.osComboBox = new JComboBox(new String[] { "Both", "Windows10", "Ubuntu" });
        this.add(osComboBox);
        
        JLabel softwareLabel = new JLabel("Software ", JLabel.RIGHT);
        this.add(softwareLabel);
        
        this.softwareComboBox = new JComboBox(new String[] {"Netbeans", "Java" });
        ...
        else
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    if(os.equals("Both"))
                    {
                        room.setHasWindows10(true);
                        room.setHasUbuntu(true);
                    }
                    ...
                    {
                        room.setHasJava(true);
                        room.setHasNetBeans(true);
                    }
                    else if(softwares.equals("Java"))
                    {
                        room.setHasJava(true);
                    }
