...
//            // when the file cannot be loaded, we load default values
            ...
            Room room1 = new Room(10, "CG-1");
            room1.setHasJava(true);
            room1.setHasNetBeans(true);
            room1.setHasUbuntu(true);

                Room room2 = new Room(15, "cg-02");
            room2.setHasNetBeans(true);
            room2.setHasWindows10(true);
            room2.setHasUbuntu(true);

            Room room3 = new Room(20, "CG-03");
            room3.setHasWindows10(true);
            room3.setHasJava(true);

            Room room4 = new Room(15, "CG-04");
            room4.setHasUbuntu(true);
            room4.setHasNetBeans(true);

            Room room5 = new Room(10, "CG-05");
            room5.setHasUbuntu(true);
            room5.setHasJava(true);
